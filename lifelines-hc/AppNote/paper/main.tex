...
\begin{figure*}[t!]
  ...
  \caption{%
    ...
    Bottom row: per-interval \emph{signed} $-\!\log_{10}$(hypergeometric
    p-value) --- upward bars mark excess events in the treatment arm,
    downward bars excess in the control arm. Dashed lines are the
    per-direction HCHG thresholds; bars reaching beyond either line are
    highlighted in red and coincide exactly with the intervals shaded
    above.
    %
